    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand js-scroll-trigger" href="index2.php"><?php echo $_SESSION['ses_uname']; ?></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                   ...
                   <li class="nav-item mx-0 mx-lg-1"><a  href="#portfolio" <button type="button" class="btn btn-primary" >สินค้า</button>
							</a></li>
			<li class="nav-item mx-0 mx-lg-2"><a href="basket.php"
	   <button type="button" class="btn btn-primary" >ตะกร้าสินค้า </button>
					
	</a></li> 
						<li class="nav-item mx-0 mx-lg-2"><a href="index.php"
	   <button type="button" class="btn btn-primary" >ออกจากระบบ </button>
        ...
        <!-- Masthead-->
            ...
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="design/BC_CLUB.jpg" alt="" width="1350" height="700" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">สวัสดีคุณ <?php echo $_SESSION['ses_uname']; ?></h1>
				<!-- Icon Divider-->
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
				...
				<a href="index2.php" class="btn btn-success">สินค้าทั้งหมด</a>
...
<div class="form-group">
  ...
  <div class="col-md-4">
	...
	$sql = "select * from products where ( p_name like '%$kw%' or p_detail like '%$kw%'or p_price like '%$kw%' ) $s ";
	$rs = mysqli_query($conn, $sql) ;
	$i = 0;
	while ($data = mysqli_fetch_array($rs)){
		$i++;
