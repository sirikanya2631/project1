        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-2"><a href="index2.php"
	   <button type="button" class="btn btn-primary" >กลับไปหน้าสินค้า </button>
	</a></li>
...
<div class="form-group">
  ...
  <div class="col-md-4">
	...
	$sql = "select * from shirtdb where ( p_name like '%$kw%' or p_detail like '%$kw%'or p_price like '%$kw%' ) $s ";
	$rs = mysqli_query($conn, $sql) ;
	$i = 0;
        ...
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              ราคา <?php echo $data ['p_price']; ?>บาท<br>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <a href="shirt/shirt.php"
									   <button type="button" class="btn btn-primary" >เลือกสินค้า </button>
								</a>
